...
class Oblig1UnitTest {
    ...
    void antallUlikeSortert() {
        ...
        if (Oblig1.antallUlikeSortert(a) != 5) {
            System.out.println("Oppgave 1: " + Oblig1.antallUlikeSortert(a));
        }
        if (Oblig1.antallUlikeSortert(b) != 0) {
            System.out.println("Oppgave 2: " + Oblig1.antallUlikeSortert(b));
        }
        if (Oblig1.antallUlikeSortert(c) != 7) {
            System.out.println("Oppgave 3: " +Oblig1.antallUlikeSortert(c));
        }
    }
